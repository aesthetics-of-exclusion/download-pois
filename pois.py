################################################################################
# Module: pois.py
# Adapted from https://github.com/gboeing/osmnx by Bert Spaan
...
from osmnx.geo_utils import geocode, bbox_to_poly
from osmnx.utils import log


def parse_poi_query(north, south, east, west, amenities=None, shops=None, timeout=180, maxsize=''):
    """
    ...
    shops : list
        List of shops that will be used for finding the POIs from the selected area.
    timeout : int
        Timeout for the API request.
    """
    if amenities and shops:
...
def osm_poi_download(polygon=None, amenities=None, shops=None, north=None, south=None, east=None, west=None,
    ...
    if polygon:
        ...
        query = parse_poi_query(amenities=amenities, shops=shops, west=west, south=south, east=east, north=north)
...
def create_poi_gdf(polygon=None, amenities=None, shops=None, north=None, south=None, east=None, west=None):
    """
    ...
    responses = osm_poi_download(polygon=polygon, amenities=amenities, shops=shops, north=north, south=south, east=east, west=west)
